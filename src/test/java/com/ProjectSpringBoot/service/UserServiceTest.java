...
import com.projectSpringBoot.service.MailSender;
...
//эмуляции бд( возвращение пользователя , когда на классе userRepository вызывается метод findByUsername c аргументом "John'
    ...
    public void activateUserFailTest() {
        boolean isUserActivated = userService.activateUser("activate false");
